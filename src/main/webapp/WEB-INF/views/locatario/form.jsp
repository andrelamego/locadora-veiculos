...
<div class="page-title"><i class="bi ${empty locatario.cpf ? 'bi-plus-circle' : 'bi-pencil-square'}" aria-hidden="true"></i>${empty locatario.cpf ? 'Novo Locatário' : 'Editar Locatário'}</div>
