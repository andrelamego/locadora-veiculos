...
<div class="page-title"><i class="bi ${empty categoria.id ? 'bi-plus-circle' : 'bi-pencil-square'}" aria-hidden="true"></i>${empty categoria.id ? 'Nova categoria' : 'Editar categoria'}</div>
